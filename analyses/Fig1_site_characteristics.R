...
## Header ## 
## script: Fig 1: Site Characteristics

## script purpose: create a figure of site MAP, temp, average BP dominance, and annual / perennial and c3/c4
...
FG = read.csv(here::here("data","edge_species_info_CP_BA.csv")) #Read in functional group info
