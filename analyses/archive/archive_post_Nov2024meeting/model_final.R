...
check_model(md4s)
## ggsave("figures/Dec2024/model_checks/md4s_modelcheck.png", width = 18, height = 20)
...
check_model(md4t)
## ggsave("figures/Dec2024/model_checks/md4t_modelcheck.png", width = 18, height = 20)
...
check_model(mpds_full)
## ggsave("figures/Dec2024/model_checks/mpds_full_modelcheck.png", width = 18, height = 20)
...
check_model(mpdt_full)
## ggsave("figures/Dec2024/model_checks/mpdt_full_modelcheck.png", width = 18, height = 20)
...
print(xtable(summary(mpds_first)$coefficients))
...
print(xtable(summary(mpdt_first)$coefficients))
...
print(xtable(summary(mpds_final)$coefficients))
...
print(xtable(summary(mpdt_final)$coefficients))
